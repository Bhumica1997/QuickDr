    ...
    private void displaySelectedScreen(int id) {
        ...
        switch(id) {
            case R.id.nav_doctor:fragment = new doctor();
                break;
            case R.id.nav_pharmacy:fragment = new pharmacy();
                break;
            case R.id.nav_pathology:fragment = new pathology();
                break;
            case R.id.nav_ambulance:fragment = new ambulance();
                break;
            case R.id.nav_bloodbank:fragment = new bloodbank();
                break;
